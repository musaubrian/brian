    ...
    <div>
        <div class="w-full flex flex-col justify-center items-center p-3">
            <div class="md:w-5/6 mt-3">
                <NuxtImg height="20px" width="20px" src="/static/avataaars.png" alt="avatar"
                    class=" rounded-full w-[50px] h-[50px] md:block my-2 md:hidden" placeholder />
                <h1 class="font-bold text-5xl md:hidden">I'm Ernest</h1>

                <div class="md:inline-flex hidden w-full items-center">
                    <NuxtImg height="20px" width="20px" src="/static/avataaars.png" alt="avatar"
                        class=" rounded-fullmd:block my-2 w-[10vw] h-1/6 mr-3" placeholder />
            ...
            <div class="socials w-5/6">
                <NuxtLink to="https://twitter.com/_musaubrian" target="_blank" class="social-icons">
                ...
                <NuxtLink href="https://linkedin.com/in/ernest-musau" target="_blank" class="social-icons">
                ...
                <NuxtLink href="https://github.com/musaubrian" target="_blank" class="social-icons">
                    <svg class="w-10 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 512">
                        <path
