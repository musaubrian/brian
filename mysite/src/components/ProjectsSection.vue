...
<template>
    <div class="my-4 h-auto" ref="targetCard">
        <div class="grid grid-cols-1 md:grid-cols-3 md:gap-4 w-full px-4 md:px-2 capitalize">
            <div class="col-span-1 w-full h-auto bg-slate-400 p-4 flex flex-col items-center rounded-lg my-2">
